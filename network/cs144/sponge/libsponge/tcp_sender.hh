...
class TCPSender {
  ...
  public:
    ...
    void send_noempty_segment(TCPSegment &tcpSegment, size_t remain);
...
class TCPTimer {
  ...
  public:
    TCPTimer(){};
    void restart(const unsigned int value);
};
